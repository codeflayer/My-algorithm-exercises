...
/**
 *
 * https://blog.csdn.net/seagal890/article/details/90734266
 *
 * JAVA算法：创建图算法（构建图）
 *
 * 分类专栏： 算法分析与设计 文章标签： 算法分析和设计 JAVA算法 JAVA 图
 * JAVA算法：创建图算法（构建图）
 *
 * 有北京、上海、广州、重庆、武汉、南昌五个城市，它们之间的关系和路径成本如图所示。
 * ![img](https://img-blog.csdnimg.cn/20190601222322884.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3NlYWdhbDg5MA==,size_16,color_FFFFFF,t_70)
 *
 * 现在需要编写一个算法使用邻接矩阵表示上面的图。
 *
 * https://img-blog.csdnimg.cn/20190601222346784.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3NlYWdhbDg5MA==,size_16,color_FFFFFF,t_70
 *
 */
public class MapDFS {
